"""Tests for RecordResult class (RecordResult kept as silent alias)."""

import pytest

from skua.result import RecordResult, RecordResult


class TestRenameAlias:
    """RecordResult is kept as a silent alias for back-compat."""

    def test_record_result_is_record_result(self):
        # Old imports must still resolve to the same class — any code
        # referencing `RecordResult` from before 0.11 must keep working.
        assert RecordResult is RecordResult

    def test_class_name_is_record_result(self):
        # Tracebacks and IDE hover should say RecordResult, not RecordResult.
...
class TestRecordResultBasics:
    ...
    def test_repr_returns_object_repr(self):
        ...
        obj = [1, 2, 3]
        result = RecordResult(obj=obj, url="https://skua.dev/r/abc", metadata={})
...
class TestRecordResultComparison:
    ...
    def test_equality_with_record_result(self):
        ...
        result1 = RecordResult(obj=obj1, url="https://skua.dev/r/abc", metadata={})
        result2 = RecordResult(obj=obj2, url="https://skua.dev/r/def", metadata={})
        result3 = RecordResult(obj=obj3, url="https://skua.dev/r/ghi", metadata={})
    ...
    def test_comparison_operators(self):
        ...
        result1 = RecordResult(obj=5, url="https://skua.dev/r/abc", metadata={})
        result2 = RecordResult(obj=10, url="https://skua.dev/r/def", metadata={})
...
class TestRecordResultArithmetic:
    ...
    def test_addition(self):
        ...
        result = RecordResult(obj=5, url="https://skua.dev/r/abc", metadata={})
    ...
    def test_subtraction(self):
        ...
        result = RecordResult(obj=10, url="https://skua.dev/r/abc", metadata={})
    ...
    def test_power(self):
        """Test power operator."""
        result = RecordResult(obj=2, url="https://skua.dev/r/abc", metadata={})
...
class TestRecordResultWithDataFrame:
    ...
    def test_dataframe_operations(self):
        ...
        result = RecordResult(obj=df, url="https://skua.dev/r/abc", metadata={})
...
class TestRecordResultWithMatplotlib:
    ...
    def test_figure_has_repr_png(self):
        ...
        result = RecordResult(obj=fig, url="https://skua.dev/r/abc", metadata={})
...
class TestRecordResultEdgeCases:
    ...
    def test_none_object(self):
        ...
        result = RecordResult(obj=None, url="https://skua.dev/r/abc", metadata={})
    ...
    def test_complex_metadata(self):
        ...
        result = RecordResult(obj=[1, 2, 3], url="https://skua.dev/r/abc", metadata=metadata)
